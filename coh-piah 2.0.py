...
def calcula_assinatura(texto):
    ...
    for palavra in lista_palavras:
        ...
        for elemento in range(len(caracteres_especiais)):
            palavra = palavra.replace(caracteres_especiais[elemento], '')
    ...
    for frase in lista_frases_formatadas:
        frase = frase.rstrip()
        caracteres_frase = len(frase)
        soma_caracteres_frases = soma_caracteres_frases + caracteres_frase

    for palavra in lista_palavras:
        caracteres_especiais_gerais = ',.;:!?'
        total_caracteres_especiais = 0
        for aparicao in range(len(caracteres_especiais_gerais)):
            total_caracteres_especiais = total_caracteres_especiais + 1
    pal = (soma_caracteres_frases + total_caracteres_especiais) / len(lista_frases_formatadas)
